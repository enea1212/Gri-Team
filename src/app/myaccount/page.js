...
export default function MyAccountPage() {
  ...
  return (
    <div className="ann-container">
      ...
      {profil && (
        <>
          <p className="ann-text"><strong>Username:</strong> {profil.utilizator.username}</p>
          <button
            className="ann-button"
      ...
      {profil && profil.anuntPublicat ? (
        <div className="ann-infolist">
          <h3 style={{ marginTop: '1rem' }}>Anunțurile mele:</h3>
        ...
        <h3 style={{ marginTop: '2rem' }}>Programări primite</h3>
        ...
        <h3 style={{ marginTop: '2rem' }}>Programările mele</h3>
